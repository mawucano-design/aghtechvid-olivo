...
def create_preference(email, amount=150.0, description="Suscripción mensual - Analizador de Vid"):
    """
...
st.set_page_config(page_title="Analizador de Vid", page_icon="🍇", layout="wide", initial_sidebar_state="expanded")
...
def init_session_state():
    defaults = {
        ...
        'resultados_todos': {},
        'plantas_detectadas': [],  # Cambiado de palmas_detectadas
        ...
        'variedad_seleccionada': 'Malbec',  # Variedad por defecto de vid
        'textura_suelo': {},
        'textura_por_bloque': [],
        'datos_fertilidad': [],
        'analisis_suelo': True,
...
# ===== DETECCIÓN DE PLANTAS (cambiado de palmas) =====
...
<div class="hero-banner">
    <h1 class="hero-title">🍇 ANALIZADOR DE VID SATELITAL</h1>
...
if st.session_state.analisis_completado:
    ...
    if gdf_completo is not None:
        ...
        with tab6:
            ...
            st.caption("Basado en NDVI real y modelos de fertilidad típicos para vid.")
        ...
        with tab9:
            ...
            if st.session_state.demo_mode:
                ...
                st.markdown("""
                Esta herramienta utiliza modelos YOLO para detectar automáticamente signos de enfermedades o plagas en imágenes de vid.
...
<div style="text-align: center; color: #94a3b8; padding: 20px;">
    <p><strong>© 2026 Analizador de Vid Satelital</strong></p>
