...
# 
# - Registro e inicio de sesión de usuarios.# app.py - Versión definitiva con Earthaccess (MODIS desde NASA Earthdata) y fallback a pyhdf
# 
...
def init_session_state():
    defaults = {
        ...
        'crop_type': 'Vid',             # tipo de cultivo
        'variedad_seleccionada': 'Malbec',  # valor por defecto
        'textura_suelo': {},
        'textura_por_bloque': [],
        'datos_fertilidad': [],
        'analisis_suelo': True,
...
# ===== CONFIGURACIONES =====
# Variedades de Vid (Argentina y Europa)
VARIEDADES_VID = [
...
# Variedades de Olivo (Argentina y Europa)
VARIEDADES_OLIVO = [
